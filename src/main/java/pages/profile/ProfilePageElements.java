...
public enum ProfilePageElements {
    ...
    NEW_PASSWORD_INPUT("'New password' Input", "//label[text()='New password']/.."),
    ...
    CURRENT_PASSWORD_INPUT("'Current password' Input", "//label[text()='Current password']/.."),
    UPDATE_PASSWORD_BUTTON( "'Update Password' Button", "//span[contains(text(),'Update password')]/.."),
    CONFIRM_NEW_PASSWORD_INPUT("'Confirm New password' Input", "//label[text()='Confirm new password']/..");
