...
public enum AbstractUserSidebarElements {
    ...
    CREATE_USER_SIDEBAR("Create User popup", "//*[@id = 'dialog']"),
    CREATE_USER_ACTIVE("'Create User' active", "//div/span/form//input[@id='input-1111']"),
    CREATE_USER_SIDEBAR_TITLE("'Create User' popup title", "//div[@class='v-toolbar__title']"),
    CREATE_USER_USERNAME("'Create User' name", "//div[@class='v-card__text']//input[@id='input-1137']"),
    CREATE_USER_SIDEBAR_CLOSE("'Create User' popup close", "//header/div/button/span[@class='v-btn__content']/i"),
