...
public class PlatformFilter extends BaseFilter {
    ...
    private SelenideElement mobileWebCheckBox = $x(PlatformFilterElements.MOBILE_WEB_CHECkBOX.getSelector())
            .as(PlatformFilterElements.MOBILE_WEB_CHECkBOX.getAlias());
}
