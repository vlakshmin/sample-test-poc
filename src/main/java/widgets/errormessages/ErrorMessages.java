...
public enum ErrorMessages {
    ...
    //Media
    MEDIA_NAME_ERROR_ALERT("'Media Name' Error Alert Text", "The Name field is required"),
    ...
    PUBLISHER_NAME_ERROR_ALERT("'Publisher Name' Error Alert Text", "The Name field is required"),
    ...
    AD_SPOT_NAME_ERROR_ALERT("'Ad Spot Name' Error Alert Text", "The Name field is required"),
