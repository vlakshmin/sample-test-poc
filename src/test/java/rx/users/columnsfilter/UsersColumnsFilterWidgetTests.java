...
public class UsersColumnsFilterWidgetTests extends BaseTest {
    ...
    public void testRoleChipWidgetComponent() {
        ...
        testStart()
                ...
                .then("All options should be unselected")
                .validateAttribute(filter.getRoleFilter().getAdminPublisherCheckBox(),"aria-selected","false")
                .validateAttribute(filter.getRoleFilter().getCrossPublisherCheckBox(),"aria-selected","false")
                .validateAttribute(filter.getRoleFilter().getSinglePublisherCheckBox(),"aria-selected","false")
                .and("Select Admin")
                .clickOnWebElement(filter.getRoleFilter().getAdminPublisherCheckBox())
                .validateAttribute(filter.getRoleFilter().getAdminPublisherCheckBox(),"aria-selected","true")
                ...
                .validateAttribute(filter.getRoleFilter().getAdminPublisherCheckBox(),"aria-selected","true")
                .validateAttribute(filter.getRoleFilter().getCrossPublisherCheckBox(),"aria-selected","true")
                ...
                .validateAttribute(filter.getRoleFilter().getAdminPublisherCheckBox(),"aria-selected","true")
                .validateAttribute(filter.getRoleFilter().getCrossPublisherCheckBox(),"aria-selected","true")
                .validateAttribute(filter.getRoleFilter().getSinglePublisherCheckBox(),"aria-selected","true")
                .and("Click on Back")
